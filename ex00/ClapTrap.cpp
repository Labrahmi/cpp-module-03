...
/*   Updated: 2023/07/29 15:32:52 by ylabrahm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : name("Default"), hitPoints(10), energyPoints(10), attackkDamage(0)
{
...
ClapTrap::ClapTrap(std::string name) : name(name), hitPoints(10), energyPoints(10), attackkDamage(0)
{
