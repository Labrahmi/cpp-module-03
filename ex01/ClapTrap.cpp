...
/*   Updated: 2023/08/01 16:17:12 by ylabrahm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : name("Default"), hitPoints(100), energyPoints(50), attackkDamage(20)
{
...
ClapTrap::ClapTrap(std::string name) : name(name), hitPoints(100), energyPoints(50), attackkDamage(20)
{
